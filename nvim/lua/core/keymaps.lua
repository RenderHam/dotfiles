...
-- Multiline
map("n", "<leader>m", ":MCunderCursor<cr>", { desc = "Multi Char" })

-- File Tree
map("n", "<leader>e", ":NvimTreeFocus<cr>", { desc = "File Tree Open" })
map("n", "<leader>ee", ":NvimTreeClose<cr>", { desc = "File Tree Close" })
